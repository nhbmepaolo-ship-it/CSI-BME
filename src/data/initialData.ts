...
export const INITIAL_EMPLOYEES: Employee[] = [
  {
    ...
    username: '563770',
    password: '123',
    img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=JoeSomchai&skinColor=f8d25c&hair=shortCombover&hairColor=2c1b18&top=shortFlat',
    club: 'ชมรมฟุตบอล',
    status: 'active',
    isAdmin: true,
  ...
  },
  {
    ...
    username: 'MGR_BME',
    password: '123',
    img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SurachaiMgr&skinColor=f8d25c&hair=shortWaved&hairColor=2c1b18&top=shortWaved',
    club: 'ชมรมแบตมินตัน',
    status: 'active',
    isAdmin: true,
    dept: 'Biomedical Engineering'
  },
  {
    ...
    username: 'SPV_BME',
    password: '123',
    img: 'https://api.dicebear.com/7.x/avataaars/svg?seed=PrawitSpv&skinColor=f8d25c&hair=shortSides&hairColor=2c1b18&top=shortDreads',
    club: 'ชมรมเดิน-วิ่ง',
    status: 'active',
    isAdmin: true,
    dept: 'Biomedical Engineering'
